...
t_neural_sin, u_neural_sin = neural_ode_solver(L, alpha1, num_iters=0, rde_init=True)
t_neural_sq, u_neural_sq = neural_ode_solver(L, alpha2, num_iters=0, rde_init=True)
